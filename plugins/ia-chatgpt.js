...
const handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  try {
    ...
    let sistema1 = "Eres un asistente útil. Responde de manera útil y coherente.";
    ...
    if (respuesta == 'error' || respuesta == '' || !respuesta) return 'Hubo un error al procesar tu solicitud.'; // mensaje de error
    ...
    try {
      ...
      if (botIA222.data.choices[0].text == 'error' || botIA222.data.choices[0].text == '' || !botIA222.data.choices[0].text) return 'Hubo un error al procesar tu solicitud.'; // mensaje de error
      ...
      try {
        ...
        if (empireApijson1.resultado == 'error' || empireApijson1.resultado == '' || !empireApijson1.resultado) return 'Hubo un error al procesar tu solicitud.'; // mensaje de error
