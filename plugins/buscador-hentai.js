...
const handler = async (m, {conn, text}) => {
  if (!global.db.data.chats[m.chat].modohorny && m.isGroup) throw 'Este comando no está habilitado en este chat.';
  if (!text) throw 'Por favor, ingresa un término para buscar.';
